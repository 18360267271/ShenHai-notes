...
hadoop fs -mkdir -p /origin_data/gmall/db/user_infoCopy to clipboardErrorCopied
```
...
python2 ../bin/datax.py mysql2hdfs_activity_order.jsonCopy to clipboardErrorCopied
```
...
python2 ../bin/datax.py mysql2hdfs_activity_sku.jsonCopy to clipboardErrorCopied
```
...
for root, dirs, files in os.walk(filedir):
    for name in files:
        os.system("python2 /opt/module/datax/bin/datax.py /opt/module/datax/job/gmall/" + str(name))Copy to clipboardErrorCopied
